...
public interface IMyAidlInterface extends android.os.IInterface
{
  ...
  {
    @Override public void addPerson(com.drsports.server.Person person) throws android.os.RemoteException
    {
    }
    @Override public java.util.List<com.drsports.server.Person> getPersonList() throws android.os.RemoteException
    {
      return null;
    }
    @Override
